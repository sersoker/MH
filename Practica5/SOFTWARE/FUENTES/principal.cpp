...
int main(){
	...
	cout << "-----------------" << endl;
	cout << "Menú:" << endl;
	cout << "Opción 1: ejecutar AM1" << endl;
	cout << "Opción 2: ejecutar AM2" << endl;
	cout << "Opción 3: ejecutar AM3" << endl;
	...
	while(opcionMenu != 4){
		...
		switch(opcionMenu){
			case 1:
				cout << "Ejecutando AM1. Simulación 1: " << numSimulacion << endl;
				am1(mitad1,vNormalizado,resultado,filasMitad1,num_atributos,resultado);
				break;

			case 2:
				cout << "Ejecutando AM2. Simulación 2: " << numSimulacion << endl;
				am2(mitad1,vNormalizado,resultado,filasMitad1,num_atributos,resultado);
				break;
			case 3:
				cout << "Ejecutando AM3. Simulación 3: " << numSimulacion << endl;
